...
import { validateShippingInfo } from "../utils/orderValidation.js";
...
export const newOrder = TryCatch(
  async (req: Request<{}, {}, NewOrderRequestBody>, res, next) => {
    ...
    const validatedShippingInfo = validateShippingInfo(shippingInfo);
...
export const generateInvoice = TryCatch(async (req, res, next) => {
  ...
  const invoiceBuffer = await generateInvoiceBuffer(order, customerName);
